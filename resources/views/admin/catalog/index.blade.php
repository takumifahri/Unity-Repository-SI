...
<head>
    ...
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-grid.css.map')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-grid.min.css')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-grid.min.css.map')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-reboot.css')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-reboot.css.map')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-reboot.min.css')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap-reboot.min.css.map')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap.css')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap.css.map')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{asset('bootstrap-css/css/bootstrap.min.css.map')}}">
    <script src="{{asset('bootstrap-css/js/bootstrap.bundle.js')}}"></script>   
    <script src="{{asset('bootstrap-css/js/bootstrap.bundle.js.map')}}"></script>
    <script src="{{asset('bootstrap-css/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('bootstrap-css/js/bootstrap.bundle.min.js.map')}}"></script>
    <script src="{{asset('bootstrap-css/js/bootstrap.js')}}"></script>
    <script src="{{asset('bootstrap-css/js/bootstrap.js.map')}}"></script>
    <script src="{{asset('bootstrap-css/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('bootstrap-css/js/bootstrap.min.js.map')}}"></script> --}}
    <!-- Styles / Scripts -->
    ...
    <x-sidebar>
        <div class="container mt-5">
            <div class="flex justify-between">
                <h2 class="mb-4">Catalog Data</h2>
                {{-- <button type="button" class="btn btn-primary" onclick="window.location='{{ route('catalog.createAdmin') }}'">
                    Add Data
                </button> --}}
